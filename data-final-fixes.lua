...
if settings.startup["vannila-ammiak"].value == false then require("prototypes.ammoniak") end
...
if mods["Cerys-Moon-of-Fulgora"] then require("prototypes.integer.ceris") end
